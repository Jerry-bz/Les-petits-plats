import { listOfIngredients,listOfDevices,listOfUtensils } from "../Factories/listsFactories.js";
...
// Affichage des ingrédients sur la page d'acceuil lors du click sur le bouton
 function displayListIngredients() {
    ...
    for (let element of listOfIngredients) {
        ...
        const listIngredients = document.querySelector('.selection__button__list__ingredients')
        listIngredients.append(ingredient)
        console.log(listIngredients);
    }

    const buttonIngredients = document.querySelector('.selection__button--ingredients');
    const containerListIngredients = document.querySelector('.selection__options__button__ingredients');
    const closeButton = document.querySelector('.selection__button__ingredients').children[1];
...
// Affichage des appareils sur la page d'acceuil lors du click du bouton 
  function displayListDevices() {
    ...
    const containerListDevices = document.querySelector('.selection__options__button__devices');
    const closeButton = document.querySelector('.selection__button__devices').children[1];
...
//  Affichage des ustensils lors du click du bouton 
 function displayListUtensils() {
    ...
    const containerListUtensils = document.querySelector('.selection__options__button__utensils');
    const closeButton = document.querySelector('.selection__button__utensils').children[1];
